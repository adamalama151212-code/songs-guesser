...
class DifficultyScreen extends StatefulWidget {
  // WYBRANY ARTYSTY I FUNKCJE CALLBACK
...
class _DifficultyScreenState extends State<DifficultyScreen> {
  ...
  // WSPÓLNY STYL DLA PRZYCISKÓW TRUDNOŚCI
  ButtonStyle _difficultyButtonStyle(String level) {
    final isSelected = _selectedDifficulty == level;
    return ElevatedButton.styleFrom(
      // Stała szerokość dla spójności
      fixedSize: const Size(200, 45),

      // Kolory i ramka
      foregroundColor: Colors.white,
      backgroundColor: isSelected
          ? const Color.fromARGB(255, 160, 140, 187) // Fioletowy gdy wybrany
          : Colors.black.withOpacity(0.4), // Ciemny, gdy nie wybrany
      side: BorderSide(
