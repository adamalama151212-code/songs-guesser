...
class ArtistService {
  ...
  // [3] Ścieżka zasobu. Trzymamy '/artists' osobno, żeby nie dublować jej w base URL.
  static const String _artistsPath = '/artists';
  static const String _songsPath = '/songs';

  /// [4] Pobiera listę artystów z backendu
  /// Kontrakt:
  /// - GET {baseUrl}/artists
  /// - Akceptuje: application/json
  /// - Timeout: 8s (żeby UI nie wisiał w nieskończoność)
  /// - Obsługuje dwa kształty odpowiedzi:
  ///   a) ["AC/DC", "Queen", ...]
