...
class GameScreen extends StatefulWidget {
  // Konstruktor nadal wymaga funkcji onArtistSelected do przekazania danych
...
class _GameScreenState extends State<GameScreen> {
  ...
  Future<void> _loadArtists() async {
    try {
      ...
      setState(() {
        _error = e.toString();
        _isLoading = false;
        // Brak fallback - polegamy wyłącznie na API
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Obsługa błędu - pokazuj komunikat i przycisk retry
    if (_error != null) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
